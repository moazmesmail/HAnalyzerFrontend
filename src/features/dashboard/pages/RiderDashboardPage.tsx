  ...
  return (
    <>
        <section className="hp-content">
          ...
          <div className="hp-stats"><StatCard icon={<CalendarMonthRounded />} eyebrow="NEXT LESSON" title="Today, 05:00 PM" detail="Flatwork Fundamentals" /><StatCard icon={<PetsRounded />} eyebrow="MY HORSE" title="Valentino" detail="9 yrs · Warmblood" /><StatCard icon={<AccessTimeRounded />} eyebrow="SESSION STARTS IN" title="02 : 15 : 36" detail="Main Arena" /><StatCard icon={<StarRounded />} eyebrow="PACKAGE BALANCE" title="8 lessons" detail="Valid until Jun 30" /></div>
